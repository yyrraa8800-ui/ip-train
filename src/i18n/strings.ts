...
const en: Dict = {
  ...
  no_history_yet: 'No completed workouts yet.',
  records_title: 'Personal records',
  body_weight: 'Body weight',
  log_weight: 'Log weight',
  add: 'Add',
  total_volume: 'Volume',
  rest_length: 'Default rest (seconds)',
...
const ar: Dict = {
  ...
  lb: 'رطل',
  // features
  plates: 'الأوزان لكل جانب',
  workout_history: 'سجل التمارين',
  no_history_yet: 'لا توجد تمارين مكتملة بعد.',
  records_title: 'الأرقام القياسية',
  body_weight: 'وزن الجسم',
  log_weight: 'سجّل الوزن',
  add: 'إضافة',
  total_volume: 'الحجم',
  rest_length: 'الراحة الافتراضية (ثوانٍ)',
  bar_weight: 'وزن البار',
  // game
  xp: 'نقاط',
  rank: 'الرتبة',
  streak: 'السلسلة',
